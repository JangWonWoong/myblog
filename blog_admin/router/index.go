...
func Index(res http.ResponseWriter, req *http.Request) {
	...
	index = append(index, []byte(`<a href="/create" style="display:block;margin-bottom:20px;padding:10px 0;text-align:center;background:#d7dae0;color:#21252b;font-weight:700;border-radius:10px;">새 글 쓰기</a>`)...)
